...
static const variant_info_t veux_in_info = {
    ...
    .model = "2201116SG",
    .name = "veux_in",
    .build_fingerprint = "Redmi/veux_in/veux:11/RKQ1.211001.001/V13.0.14.0.RKCMIXM:user/release-keys",
};
...
static const variant_info_t veux_p_in_info = {
    ...
    .model = "2201116PG",
    .name = "veux_p_in",
    .build_fingerprint = "POCO/veux_p_in/veux:11/RKQ1.211001.001/V13.0.14.0.RKCMIXM:user/release-keys",
};
